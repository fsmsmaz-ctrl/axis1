...
const fieldLabels: Record<string, FieldLabel> = {
  ...
  taskNumber: { ar: 'رقم المهمة', en: 'Task No.' },
  dueDate: { ar: 'موعد الإنجاز المطلوب', en: 'Due Date' },
  startedAt: { ar: 'بدء التنفيذ', en: 'Started At' },
  closedAt: { ar: 'الإغلاق النهائي', en: 'Closed At' },
  assigneeId: { ar: 'الموظف المسؤول', en: 'Assignee' },
  reviewNote: { ar: 'الإجراء المنفذ', en: 'Action Taken' },
...
const valueLabels: Record<string, Record<string, string>> = {
  ...
  status: {
    ...
    new: 'جديدة', waiting: 'بانتظار جهة أخرى', ready_review: 'جاهزة للمراجعة', closed: 'مغلقة نهائياً', cancelled: 'ملغاة',
